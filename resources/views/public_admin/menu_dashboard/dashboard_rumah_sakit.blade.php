...
<div>
    ...
    <div class="row"> 
        @if (1==0)
        <div class="col-md-6 col-md-3 panelhamdi" style="display: none">
        ...
        <div class="col-md-6 col-md-3" style="display: none">
        ...
        <div class="col-md-12 col-md-12">
            <div style="height: 250px !important;" class="panel panel-body bg-warning-400 has-bg-image">
                ...
                <br>
                <span class="blink_me"><b><?= request()->session()->get('pabi_borang_belum_verif_rs'); ?></b> Menuggu Verifikasi Borang </span> 
                <br>
                <br>
                <br> 
                <br>  
                <br>  
                <a class="no-margin text-semibold" style="color: white" href="{{ url('/rumah-sakit/master_borang_belum_verif') }}">
                    Selengkapnya...
                </a>
            </div>
        </div> 
        @if (1==0)
        <div class="col-sm-6 col-md-3 panelhamdi" style="display: none">
    ...
    <!-- Form horizontal -->
    @if (1==0)
    <div class="panel bg-primary" style="display: none">
    ...
    <div class="panel bg-warning" style="display: none">
        <div class="panel-heading">
            <h6 class="panel-title">
                Data Statistik
            </h6>
...
$( document ).ready(function() { 
    div_grafik_borang_pie_cabang('{{csrf_token()}}', '#pb_div_grafik_borang');
    div_grafik_ranah_bar_cabang('{{csrf_token()}}', '#div_grafik_ranah');
