        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_edit_tentang_pabi', $data_tentang_pabi['id']) }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8"> 
                                    <input required="required" type="text" class="form-control" name="judul" value="{{ $data_tentang_pabi['judul'] }}">  
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">   
                                    <textarea id="isi" name="isi" placeholder="Keterangan Tambahan" class="form-control txt_ckeditor_edit" rows="4"><?= $data_tentang_pabi['isi']; ?></textarea>  
                                </div>
                            </div> 
                            <div class="form-group status_lengkap">
                                <label for="judul" style="text-align: right;" class="col-lg-3 control-label">
                                ...
                                <div class="col-lg-8"> 
                                    <select required="required" class="form-control" name="posisi_isi" id="posisi_isi">
                                        ...
                                        <option value="2" <?php if($data_tentang_pabi['posisi_isi'] == 2){ echo 'selected'; } ?> >Kanan</option>
                                    </select> 
                                </div>
                            </div>    
                            <div class="form-group status_lengkap">
