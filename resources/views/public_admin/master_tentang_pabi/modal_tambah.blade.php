        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formTambahMasterRS" method="post" action="{{ route('simpan_tentang_pabi') }}" class="form-horizontal" enctype="multipart/form-data" >
                        <div class="modal-body">
                            ...
                            <div class="form-group status_lengkap">
                                <label style="text-align: right;" class="col-lg-3 control-label">
                                    Foto Tentang PABI <span style="color:red"><b>*</b></span> : 
                                </label>
                                <div class="col-lg-8"> 
                                    <input required="required" type="file" class="form-control" value="" id="image" name="image">  
                                </div>
                            </div>  
                        </div>
