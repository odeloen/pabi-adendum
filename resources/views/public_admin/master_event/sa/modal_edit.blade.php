        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form class="form-horizontal" enctype="multipart/form-data" id="formUbahEventAdminPusat" 
                    onsubmit="
                    if ($('#kordinat_event').val() == '' || $('#kordinat_event').val() == ';') {
                        pemberitahuan('Koordinat Belum Diisi');
                        return false;
                    } else {
                        simpan_form_ubah_event_admin_pusat('{{csrf_token()}}', '{{$id}}', '.btn_simpan_form_ubah_event_admin_pusat');
                        return false; 
                    }
                    ">
                        <div class="modal-body">
                            ...
                            <div class="form-group"<?php echo $discoladm; ?>>
                                ...
                                <div class="col-lg-8">
                                    <select data-placeholder="Pilih Admin Pusat" class="select22" name="admin_pst_id" id="admin_pst_id" style="width: 100%" required="" onchange="isa_data_bank_admin('#formUbahEventAdminPusat', 'admin_pst_id')">
                                        <option value="">-- Pilih Admin Pusat--</option> 
                                        <?php
                                        foreach ($data_admin_pusat as $dap) {
                                            ...
                                            if (session('pabi_role_id') == 2 && session('admin_pusat_id') == $dap['id']) {
                                                ...
                                                if ($data_event['admin_pusat_id'] == $dap['id']) {
                                                    $sel_adm_pst = 'selected=""';
                                                }
                                            }
                                            
                                            echo '<option bank="'.$dap['nama_bank'].'" rekening="'.$dap['no_rek'].'" pemilik="'.$dap['pemilik_rek'].'" value="'.$dap['id'].'" '.$sel_adm_pst.'>'.$dap['name'].'</option>';
                                        }
                                        ?>
                                    </select>
                                    <input type="hidden" name="admin_cab_id" id="admin_cab_id" value="{{ $data_event['admin_cabang_id'] }}">
                                    <?php
                                    $jenis_event = 'Event Nasional';
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <select data-placeholder="Pilih Jenis Event" class="select22" name="jenis_event_id" id="jenis_event_id" style="width: 100%" required="">
                                        <?php
                                        $cek_sel_jei = '';
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">  
                                    <textarea style="resize: none;" name="deskripsi" id="deskripsi" placeholder="Deskripsi" class="form-control" rows="3">{{ $data_event['deskripsi'] }}</textarea>
                                </div>
                            </div>              
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <select required="" data-placeholder="Pilih Provinsi" class="select22" style="width: 100%" name="prov_id" id="prov_id" onchange="kota_by_provinsi_id('{{csrf_token()}}', '#formUbahEventAdminPusat', 0)">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <select required="" class="select22" style="width: 100%" name="kota_id" id="kota_id" onchange="kecamatan_by_kota_id('{{csrf_token()}}', '#formUbahEventAdminPusat', 0, 0)">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-ladda btn_simpan_form_ubah_event_admin_pusat" data-style="expand-left" data-spinner-color="#333" data-spinner-size="20">
...
<script type="text/javascript"> 
    $(document).ready(function () {
        $('.select22').select2();
        kota_by_provinsi_id('{{csrf_token()}}', '#formUbahEventAdminPusat', '{{$kota_id}}');
        kecamatan_by_kota_id('{{csrf_token()}}', '#formUbahEventAdminPusat', '{{$kec_id}}', '{{$kota_id}}');
    });
    function ganti_isi(){
