...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<form onsubmit="div_tabel_expired_pembayaran_cabang('{{csrf_token()}}', '#div_tabel_expired_pembayaran_cabang'); return false;" class="form-horizontal" enctype="multipart/form-data" id="formFilterDataExpiredPembayaranEventCabang">
					<div class="row">
						...
						<div class="col-lg-7">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								...
								<div class="col-lg-9">
									<select data-placeholder="Pilih Admin Cabang" class="select22" name="admin_pst_id" id="admin_pst_id" style="width: 100%" onchange="event_by_admin_cabang('{{csrf_token()}}', this.value)">
										<option value="">-- Select Admin Cabang--</option> 
										<?php
										foreach ($data_admin_cabang as $dab) {
											$sel_adm_pst = '';
											if (session('pabi_role_id') == 3 && session('admin_cabang_id') == $dab['id']) {
												$sel_adm_pst = 'selected=""';
											}
											echo '<option value="'.$dab['id'].'" '.$sel_adm_pst.'>'.$dab['name'].'</option>';
										}
										?>
									</select>
								</div>
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Pembayaran Cabang (Khusus Expired)</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body"id="div_tabel_expired_pembayaran_cabang"> 
			</div>
		</div>
		<!-- /Panel Event -->
