        ...
        <div class="tabbable">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="active">
                    <a href="#tab_pendaftaran_event" data-toggle="tab" aria-expanded="false">
                        Buka / Tutup Pendaftaran Event Pusat
                    </a>
                </li> 
            </ul>
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_pendaftaran_event"> 
                    ...
                    ?>
                    <form class="form-horizontal" enctype="multipart/form-data" id="formModalOnOffPendaftaranPusat">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-danger" data-dismiss="modal" name="closeFormModalOnOffPendaftaranPusat" id="closeFormModalOnOffPendaftaranPusat">
                                <i class="icon-cross"></i> Close
                            </button>
                            <a class="btn btn-primary btn-ladda btn_simpan_modal_onoff_pendaftaran_pusat" data-style="expand-left" data-spinner-color="#333" data-spinner-size="20" onclick="simpan_modal_onoff_pendaftaran_pusat('{{csrf_token()}}', '{{ $id_event }}', '.btn_simpan_modal_onoff_pendaftaran_pusat')">
