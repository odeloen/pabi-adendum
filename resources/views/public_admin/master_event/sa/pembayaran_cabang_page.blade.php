...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<form onsubmit="div_tabel_pembayaran_cabang('{{csrf_token()}}', '#div_tabel_pembayaran_cabang'); return false;" class="form-horizontal" enctype="multipart/form-data" id="formFilterDataMasterEventCabang">
					<div class="row">
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Pembayaran Cabang</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body"id="div_tabel_pembayaran_cabang"> 
			</div>
		</div>
		<!-- /Panel Event -->
