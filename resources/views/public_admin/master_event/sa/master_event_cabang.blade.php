...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<form onsubmit="div_tabel_event_cabang('{{csrf_token()}}', '#div_tabel_event_cabang'); return false;" class="form-horizontal" enctype="multipart/form-data" id="formFilterDataMasterEventCabang">
					<div class="row">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								...
								<div class="col-lg-9">
									<select data-placeholder="Pilih Admin Cabang" class="select22" name="admin_cab_id" id="admin_cab_id" style="width: 100%">
										<!-- <option value="0">-- Pilih Admin Cabang--</option>  -->
										<?php
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<div>
					<a class="btn btn-info" onclick="tambah_modal_event_cabang('{{csrf_token()}}', '#ModalBiru')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div>
				<br>
				<div class="form-group" id="div_tabel_event_cabang">
