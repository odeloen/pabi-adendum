										...
										<div class="form-group">
											<div class="col-lg-3">
												<div class="onoffswitch_expired">
													...
													onclick="set_status_bayar_menunggu_bayar('{{csrf_token()}}','{{$id}}','#status_bayar_excab{{$no}}') "
													class="onoffswitch_expired-checkbox"
													name="status_bayar_excab{{$no}}" id="status_bayar_excab{{$no}}"
													value="1">
													<label class="onoffswitch_expired-label" for="status_bayar_excab{{$no}}">
