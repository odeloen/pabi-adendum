					...
					<div class="btn-group heading pull-right btn-group-velocity">
						...
						<ul class="dropdown-menu">
							...
							<li>
								...
								update_modal_event_cabang('{{csrf_token()}}', '{{ $id }}', '#ModalTeal')
							...
							<li>
								<button type="button" onclick="
								modal_onoff_pendaftaran_cabang('{{csrf_token()}}', '{{ $id }}', '#ModalIndigoSm')
							...
							<!-- <li>
								<button type="button" onclick="halaman_isi_buku_tamu('{{ $id }}')" class="btn bg-brown-400 btn-xs btn-block">
