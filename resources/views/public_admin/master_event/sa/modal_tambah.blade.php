        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form class="form-horizontal" enctype="multipart/form-data" id="formTambahEventAdminPusat" 
                    onsubmit="
                    if ($('#kordinat_event').val() == '') {
                        pemberitahuan('Koordinat Belum Diisi');
                        return false; 
                    } else {
                        simpan_form_tambah_event_admin_pusat('{{csrf_token()}}', '.btn_simpan_form_tambah_event_admin_pusat');
                        return false; 
                    }
                    ">
                        <div class="modal-body">
                            ...
                            <div class="form-group"<?php echo $discoladm; ?>>
                                ...
                                <div class="col-lg-8">
                                    <select data-placeholder="Pilih Admin Pusat" class="select22" name="admin_pst_id" id="admin_pst_id" style="width: 100%" required="" onchange="isa_data_bank_admin('#formTambahEventAdminPusat', 'admin_pst_id')">
                                    ...
                                    <input type="hidden" name="admin_cab_id" id="admin_cab_id" value="">
                                    <input type="hidden" value="Event Nasional" name="jenis_event" id="jenis_event">
                                </div>
                            </div>
                                ...
                                <div class="col-lg-8">
                                    <select data-placeholder="Pilih Jenis Event" class="select22" name="jenis_event_id" id="jenis_event_id" style="width: 100%" required="">
                                        ...
                                        foreach ($data_jenis_event as $dje) {
                                            echo '<option value="'.$dje['id'].'">'.$dje['nama_jenis_event'].'</option>';
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <select required="" data-placeholder="Pilih Provinsi" class="select22" style="width: 100%" name="prov_id" id="prov_id" onchange="kota_by_provinsi_id('{{csrf_token()}}', '#formTambahEventAdminPusat', 0)">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <select required="" class="select22" style="width: 100%" name="kota_id" id="kota_id" required="" onchange="kecamatan_by_kota_id('{{csrf_token()}}', '#formTambahEventAdminPusat', 0, 0)">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">
                                    <select required="" class="select22" style="width: 100%" name="kec_id" id="kec_id" required="">
                            ...
                            <div class="form-group status_lengkap">
                                ...
                                <div class="col-lg-8">  
                                    <textarea style="resize: none;" required="" name="lokasi_alamat" id="lokasi_alamat" placeholder="Alamat Diselenggarakannya Event" class="form-control" rows="3"></textarea>
                                </div>
                            </div>
                            <div class="form-group status_lengkap">
...
<script type="text/javascript"> 
    ...
    $( document ).ready(function() {  
        if (<?php echo session('pabi_role_id');?> == 2) {
            isa_data_bank_admin('#formTambahEventAdminPusat', 'admin_pst_id');
        }
        //CKEditor
