...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<form onsubmit="div_tabel_event_saya_member2('{{csrf_token()}}', '#div_tabel_event_saya_member'); return false;" class="form-horizontal" enctype="multipart/form-data" id="formFilterMemberEventSayaLunas">
					<div class="row">
						...
						<div class="col-lg-6">
							<div class="form-group" style="display: none">
								...
								$date_later = date('Y-m-d', strtotime('+3600 days', strtotime(date("Y-m-d"))));
								?>
								<div class="col-lg-4">
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Event Saya <b>Akan Datang</b></h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
