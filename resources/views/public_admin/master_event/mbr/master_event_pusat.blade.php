...
<div class="row">
	...
	<div class="col-lg-12">
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<form onsubmit="div_tabel_event_pusat_member('{{csrf_token()}}', '#div_tabel_event_pusat_member'); return false;" class="form-horizontal" enctype="multipart/form-data" id="formFilterMemberEventPusat">
					<div class="row">
						...
						<div class="col-lg-7">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								...
								<div class="col-lg-9">
									<select data-placeholder="Pilih Admin Pusat" class="select22" name="admin_pst_id"
									        id="admin_pst_id" style="width: 100%">
										<option value="0">-- Select Admin Pusat--</option>
										<?php
										foreach ($data_admin_pusat as $dap) {
											$sel_adm_pst = '';
											if (session('pabi_role_id') == 4 && session('admin_pusat_id') == $dap['id']) {
	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_event_pusat_member">
