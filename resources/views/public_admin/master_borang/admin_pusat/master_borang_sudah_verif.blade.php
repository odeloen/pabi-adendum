...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataBorangAdminPusatSudahVerif" onsubmit="div_tabel_borang_sudah_verif_pusat('{{csrf_token()}}', '#div_tabel_borang_sudah_verif_pusat'); return false;">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								<label for="admin_pst_id" style="text-align: right;" class="col-md-3 control-label">
									Admin Pusat : 
								</label>
								<div class="col-md-8">
									<select data-placeholder="Pilih Admin Pusat" class="select22" name="admin_pst_id" id="admin_pst_id" style="width: 100%" onchange="admin_cabang_by_admin_pusat('{{csrf_token()}}', '#formFilterDataBorangAdminPusatSudahVerif')">
										<option value="">-- Semua --</option> 
										<?php
										foreach ($data_admin_pusat as $dap) {
											$sel_adm_pst = '';
											if (session('admin_pusat_id') == $dap['id']) {
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Borang" class="select22" name="borang" id="borang" style="width: 100%" onchange="jenis_kegiatan_by_borang('{{csrf_token()}}', '#formFilterDataBorangAdminPusatSudahVerif')">
										<option value="">-- Semua --</option>
										<?php
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Jenis Kegiatan" class="select22" name="jenis_kegiatan" id="jenis_kegiatan" style="width: 100%" onchange="nama_kegiatan_by_jenis_kegiatan('{{csrf_token()}}', '#formFilterDataBorangAdminPusatSudahVerif')">
										<option value="">-- Semua --</option>
									</select>
								</div>
							</div>
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h6 class="panel-title">Master Data Borang yang <b>Sudah</b> Diverifikasi</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_borang_sudah_verif_pusat">
...
<script type="text/javascript">
	$('.btn_tampilkan').click();
	admin_cabang_by_admin_pusat('{{csrf_token()}}', '#formFilterDataBorangAdminPusatSudahVerif');
</script>
@endsection