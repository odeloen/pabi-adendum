...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataBorangAdminPusatBelumVerif" onsubmit="div_tabel_borang_belum_verif_pusat('{{csrf_token()}}', '#div_tabel_borang_belum_verif_pusat'); return false;">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								<label for="admin_pusat_id" style="text-align: right;" class="col-md-3 control-label">
									Admin Pusat : 
								</label>
								<div class="col-md-8">
									<select data-placeholder="Pilih Admin Pusat" class="select22" name="admin_pusat_id" id="admin_pusat_id" style="width: 100%" onchange="admin_cabang_by_admin_pusat('{{csrf_token()}}', '#formFilterDataBorangAdminPusatBelumVerif')">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Borang" class="select22" name="borang" id="borang" style="width: 100%" onchange="jenis_kegiatan_by_borang('{{csrf_token()}}', '#formFilterDataBorangAdminPusatBelumVerif')">
										<option value="">-- Semua --</option>
										<?php
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Jenis Kegiatan" class="select22" name="jenis_kegiatan" id="jenis_kegiatan" style="width: 100%" onchange="nama_kegiatan_by_jenis_kegiatan('{{csrf_token()}}', '#formFilterDataBorangAdminPusatBelumVerif')">
										<option value="">-- Semua --</option>
									</select>
								</div>
							</div>
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_borang_belum_verif_pusat">
...
<script type="text/javascript">
	$('.btn_tampilkan').click();
	admin_cabang_by_admin_pusat('{{csrf_token()}}', '#formFilterDataBorangAdminPusatBelumVerif');
</script>
