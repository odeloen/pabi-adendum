...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataBorangAdminCabangSudahVerif" onsubmit="div_tabel_borang_sudah_verif_cabang('{{csrf_token()}}', '#div_tabel_borang_sudah_verif_cabang'); return false;">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Borang" class="select22" name="borang" id="borang" style="width: 100%" onchange="jenis_kegiatan_by_borang('{{csrf_token()}}', '#formFilterDataBorangAdminCabangSudahVerif')">
										<option value="">-- Semua --</option>
										<?php
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Jenis Kegiatan" class="select22" name="jenis_kegiatan" id="jenis_kegiatan" style="width: 100%" onchange="nama_kegiatan_by_jenis_kegiatan('{{csrf_token()}}', '#formFilterDataBorangAdminCabangSudahVerif')">
										<option value="">-- Semua --</option>
									</select>
								</div>
							</div>
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_borang_sudah_verif_cabang">
