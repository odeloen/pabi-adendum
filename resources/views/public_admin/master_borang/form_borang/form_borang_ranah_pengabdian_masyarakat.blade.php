<form class="form-horizontal" id="formBorangRanahPengabdianMasyarakat" onsubmit="simpan_pengabdian_masyarakat('{{csrf_token()}}', '#formBorangRanahPengabdianMasyarakat', '.btn_simpan_pengabdian_masyarakat'); return false;">
    <div class="modal-body">
        ...
        <div class="form-group status_lengkap">
            ...
            <div class="col-md-7"> 
                <input type="date" class="form-control" id="tanggal_mulai" name="tanggal_mulai" required="" value="{{$tanggal_tabel}}" readonly="">  
            </div>
        </div>
        <div class="form-group status_lengkap">
        ...
        <div class="form-group status_lengkap" id="div_jenis_kegiatan_detail">
            ...
            <div class="col-md-7"> 
                <input type="text" class="form-control" id="jenis_kegiatan_detail" name="jenis_kegiatan_detail" required="">  
            </div>
        </div>
        <div class="form-group status_lengkap" id="div_nama_organisasi_event">
            ...
            <div class="col-md-7"> 
                <input type="text" class="form-control" id="nama_organisasi_event" name="nama_organisasi_event" required="">  
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn_simpan_pengabdian_masyarakat btn-ladda"  data-style="expand-left" data-spinner-color="#333" data-spinner-size="20">
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        borang_ranah_pengabdian_masyarakat('#formBorangRanahPengabdianMasyarakat');
    });
</script>