...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataBorangRumahSakitSudahVerif" onsubmit="div_tabel_borang_sudah_verif_rs('{{csrf_token()}}', '#div_tabel_borang_sudah_verif_rs'); return false;">
					<div class="row">
						...
						<div class="col-md-8">
							...
							<div class="form-group"<?php echo $discoladm; ?>>
								<label for="rs_id" style="text-align: right;" class="col-md-3 control-label">
									Rumah Sakit :
								</label>
								<div class="col-md-8">
									<select data-placeholder="Pilih Admin Cabang" class="select22" name="rs_id" id="rs_id" style="width: 100%">
										<option value="">-- Semua --</option>
										<?php
										foreach ($data_rs as $drs) {
											$sel_rs = '';
											if (session('pabi_role_id') == 5 && session('pabi_rs_id') == $drs['id']) {
												$sel_rs = ' selected=""';
											}
											echo '<option value="'.$drs['id'].'"'.$sel_rs.'>'.$drs['nama'].'<br>'.$drs['alamat'].'</option>';
										}
										?>
									</select>
									<input type="hidden" name="admin_cabang_id" id="admin_cabang_idrs" value="">
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Borang" class="select22" name="borang" id="borang" style="width: 100%" onchange="jenis_kegiatan_by_borang('{{csrf_token()}}', '#formFilterDataBorangRumahSakitSudahVerif')">
										<option value="">-- Semua --</option>
										<?php
							...
							<div class="form-group">
								...
								<div class="col-md-8">
									<select data-placeholder="Pilih Jenis Kegiatan" class="select22" name="jenis_kegiatan" id="jenis_kegiatan" style="width: 100%" onchange="nama_kegiatan_by_jenis_kegiatan('{{csrf_token()}}', '#formFilterDataBorangRumahSakitSudahVerif')">
										<option value="">-- Semua --</option>
									</select>
								</div>
							</div>
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_borang_sudah_verif_rs">
