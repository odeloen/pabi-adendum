<form class="form-horizontal" id="formUbahBorangRanahPublikasiIlmiah" onsubmit="ubah_publikasi_ilmiah('{{csrf_token()}}', '#formUbahBorangRanahPublikasiIlmiah', '.btn_ubah_publikasi_ilmiah'); return false;">
    <div class="modal-body">
        ...
        <div class="form-group status_lengkap">
            ...
            <div class="col-md-7"> 
                <input type="text" class="form-control" id="judul_artikel" name="judul_artikel" required="" value="{{$data_histori_kegiatan['judul_artikel']}}">  
            </div>
        </div>
        <div class="form-group status_lengkap">
            ...
            <div class="col-md-7"> 
                <input type="text" class="form-control" id="nama_buku_jurnal" name="nama_buku_jurnal" required="" value="{{$data_histori_kegiatan['nama_buku_jurnal']}}">  
            </div>
        </div>
    ...
    <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary btn_ubah_publikasi_ilmiah">
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.select22').select2();
        borang_ranah_publikasi_ilmiah('#formUbahBorangRanahPublikasiIlmiah');
    });
</script>