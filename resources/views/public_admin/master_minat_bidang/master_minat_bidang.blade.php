	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Master Data Minat Bidang </h6>
			...
			<div class="panel-body">
				<div>
					<a class="btn btn-info" onclick="tambah_modal_minat_bidang('{{csrf_token()}}', '#ModalBiruSm')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div>
				<br>
				<div class="">
					<table class="table table-bordered table-hover datatable-basic">
						...
						<tbody>
							...
							$no = 0;
							?>
							@foreach ($data_minat_bidang as $r) 
							@php
							$no ++;
							$id = $r['id'];
							@endphp
							<tr>
								...
								<td>  
									...
									edit_modal_minat_bidang('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
