...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataPengajuanPindahCabangMemberBelumVerif1" onsubmit="div_tabel_pengajuan_pindah_cabang_belum_verif1('{{csrf_token()}}', '#div_tabel_pengajuan_pindah_cabang_belum_verif1'); return false;">
					<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_pengajuan_pindah_cabang_belum_verif1">
