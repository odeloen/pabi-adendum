...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataPengajuanPindahCabangMemberSudahVerif2" onsubmit="div_tabel_pengajuan_pindah_cabang_sudah_verif2('{{csrf_token()}}', '#div_tabel_pengajuan_pindah_cabang_sudah_verif2'); return false;">
					<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_pengajuan_pindah_cabang_sudah_verif2">
