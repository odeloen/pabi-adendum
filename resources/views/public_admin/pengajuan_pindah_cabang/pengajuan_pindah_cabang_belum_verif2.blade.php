...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataPengajuanPindahCabangMemberBelumVerif2" onsubmit="div_tabel_pengajuan_pindah_cabang_belum_verif2('{{csrf_token()}}', '#div_tabel_pengajuan_pindah_cabang_belum_verif2'); return false;">
					<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			<div class="panel-heading">
				<h6 class="panel-title">Data Pengajuan Pindah Cabang Member yang <b>Belum</b> Diverifikasi</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_pengajuan_pindah_cabang_belum_verif2">
