...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataPengajuanPindahCabangMemberSudahVerif1" onsubmit="div_tabel_pengajuan_pindah_cabang_sudah_verif1('{{csrf_token()}}', '#div_tabel_pengajuan_pindah_cabang_sudah_verif1'); return false;">
					<div class="row">
						...
						<div class="col-md-5">
								...
								<div class="form-group"<?php echo $discoladm; ?>>
									...
									<div class="col-md-7">
										<select data-placeholder="Pilih Admin Cabang" class="select22" name="admin_cab_id" id="admin_cab_id" style="width: 100%">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			<div class="panel-heading">
				<h6 class="panel-title">Data Pengajuan Pindah Cabang Member yang <b>Sudah</b> Diverifikasi</h6>
				<div class="heading-elements">
					<ul class="icons-list">
						<li><a data-action="collapse"></a></li>
						<li><a data-action="reload"></a></li>
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_pengajuan_pindah_cabang_sudah_verif1">
