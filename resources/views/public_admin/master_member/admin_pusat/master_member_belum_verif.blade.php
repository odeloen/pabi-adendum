...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataMemberAdminPusatBelumVerif" onsubmit="div_tabel_member_belum_verif_pusat('{{csrf_token()}}', '#div_tabel_member_belum_verif_pusat'); return false;">
					<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-warning">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_member_belum_verif_pusat">
