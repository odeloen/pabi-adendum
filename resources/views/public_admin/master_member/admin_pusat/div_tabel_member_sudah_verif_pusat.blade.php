									...
									<div class="btn-group btn-block btn-group-velocity">
										...
										<ul class="dropdown-menu">
											<li>
												...
												update_modal_verif_pusat('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
											...
											<li>
												<button type="button" onclick="inactive_master_member('{{csrf_token()}}','{{ $id }}','#ModalBrownSm', 'admin/master_member_sudah_verif_pusat')" data-toggle="modal" class="btn bg-brown-400 btn-xs btn-block">
			...
			<td>
				<div class="btn-group btn-block btn-group-velocity">
					...
					<ul class="dropdown-menu">
						...
						<li>
							<button type="button" onclick="inactive_master_member('{{csrf_token()}}','{{ $user_id }}','#ModalTealSm')" data-toggle="modal" class="btn btn-warning btn-xs btn-block">
