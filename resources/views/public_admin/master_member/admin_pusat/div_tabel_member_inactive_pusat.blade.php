								...
								<div class="text-right">
									<div class="btn-group btn-block btn-group-velocity">
										...
										<ul class="dropdown-menu">
											...
											<li>
												<button type="button" onclick="inactive_master_member('{{csrf_token()}}','{{ $id }}','#ModalBrownSm', 'admin/master_member_inactive_pusat')" data-toggle="modal" class="btn bg-brown-400 btn-xs btn-block">
