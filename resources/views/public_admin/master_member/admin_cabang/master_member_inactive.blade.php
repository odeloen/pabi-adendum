...
<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<form class="form-horizontal" enctype="multipart/form-data" id="formFilterDataMemberAdminCabangInactive" onsubmit="div_tabel_member_inactive_cabang('{{csrf_token()}}', '#div_tabel_member_inactive_cabang'); return false;">
					<div class="row">
	...
	<div class="col-md-12">
		<div class="panel panel-success">
			...
			<div class="panel-body">
				<div class="form-group" id="div_tabel_member_inactive_cabang">
