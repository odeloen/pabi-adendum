	...
	<div class="col-lg-12">
		...
		<div class="panel panel-indigo">
			<div class="panel-heading">
				<h6 class="panel-title">Master Data Admin Pusat</h6>
			...
			<div class="panel-body">
				<div>
					<a class="btn btn-info" onclick="tambah_modal_admin_pusat('{{csrf_token()}}', '#ModalBiruSm')">Tambah Data <i class="icon-plus3 position-right"></i></a>
				</div>
				<br>
				<div class="">
									...
									<div class="btn-group btn-block btn-group-velocity">
										...
										<ul class="dropdown-menu">
											<li>
												...
												update_modal_admin_pusat('{{csrf_token()}}', '{{ $id }}', '#ModalTealSm')
												" id="modal_update_barang" class="btn bg-teal-400 btn-xs btn-block">
												<i class="glyphicon glyphicon-edit"></i>Edit</button> 
											</li> 
											<li>
												<button type="button" onclick="delete_master_admin_pusat('{{csrf_token()}}','{{ $id }}')"
