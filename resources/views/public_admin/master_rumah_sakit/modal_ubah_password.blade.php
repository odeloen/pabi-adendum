        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="tab_verifikasi"> 
                    <form id="formUbahPassMasterRS" method="post" action="{{ route('simpan_reset_password_rs', $user_id) }}" class="form-horizontal" enctype="multipart/form-data" onsubmit="if ($('#password').val() == $('#password_confirmation').val()) { return true; } else { alert('Password tidak sama'); return false; }">
