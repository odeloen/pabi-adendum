...
<section style="display: none" id="tabs-1" class="wide-100 tabs-section division">
	<div class="container">	
		<div class="row">
			<div class="col-md-12">
...
<div id="statistic-1" class="bg-scroll statistic-section division">
	<div class="container white-color">
		<div class="row">
			...
			<!-- STATISTIC BLOCK #1 -->
			<div style="display: none" class="col-md-6 col-lg-3">						
...
<!-- STATISTIC-hamdi
============================================= -->
<div id="statistic-hamdi" class="bg-scroll statistic-section division">
	<div class="container white-color">
		<div class="row"> 
...
</div>     <!-- END STATISTIC-hamdi --> 
<form style="display: none" class="row hero-form" enctype="multipart/form-data" id="formFilterMasterDokterHalamanAwal" >
