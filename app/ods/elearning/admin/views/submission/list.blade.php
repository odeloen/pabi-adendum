        ...
        <table class="table datatable-basic table-hover table-bordered">
            ...
            <tbody>
                @foreach ($submissions as $submission)
                    <tr>
                        <td>{{$submission->instance->created_at}}</td>
                        <td>{{$submission->instance->created_at_string}}</td>
                        <td style="width:1%;whitespace:nowrap;">{{$submission->instance->unique_code}}</td>
                        <td>
                            "{{$submission->instance->name}}"<br>
                        ...
                        <td class="text-center" style="width:1%;whitespace:nowrap;">
                            <a href="{{route('admin.submission.show', $submission->instance->id)}}">
