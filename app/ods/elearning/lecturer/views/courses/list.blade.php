...
@if (!empty($courses))
    @foreach ($courses as $course)
        ...
        @endif
        <div class="col-lg-6" >
            <a href="{{route('lecturer.course.show', $course->instance->id)}}" style="text-decoration:none;color:inherit;">
                ...
                <div class="panel-body">
                    <div class="col-lg-12">
                        <div class="thumb">
                            @if (!empty($course->instance->image_path != null))
                                <img src="{{env('APP_URL')}}/sl/images/{{$course->instance->image_path}}" class="img-responsive img-rounded" alt="" style="max-height:100px; width:auto; width:auto;">
                            @else
                                ...
                                <div class="content-group-sm media blog-title stack-media-on-mobile text-left">
                                    <div class="media-body">
                                        ...
                                        <ul class="list-inline list-inline-separate no-margin text-muted">
                                            ...
                                            <li>diperbarui <span style="color: #3F51B5">{{Carbon\Carbon::parse($course->instance->updated_at)->formatLocalized('%d %B %Y')}}</span></li>
                                            <li>
                    ...
                    <div class="panel-footer panel-footer-condensed">
                        <div class="heading-elements">
                            <a href="{{route('lecturer.course.show', $course->instance->id)}}" class="heading-text pull-right">Lihat Kelas <i class="icon-arrow-right14 position-right"></i></a>
                        </div>
                    </div>
                </div>
            </a>
...
<div id="modal_classAdd" class="modal fade" tabindex="-1" style="overflow-y: auto;">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="{{route('lecturer.course.create')}}" method="POST" enctype="multipart/form-data">
                @csrf
