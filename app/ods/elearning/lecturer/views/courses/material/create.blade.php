...
<div class="page-header page-header-inverse">
    <div class="page-header-content bg-indigo">
        <div class="page-title">
            <h5>
                @if (!empty($course))
                    {{$topic->instance->name}} - {{$course->instance->name}}
                @endif
            </h5>
        </div>
    </div>
...
<div class="panel">
    ...
    <form action="{{route('lecturer.material.store')}}" class="form-horizontal" method="POST" enctype="multipart/form-data">
        @csrf
        <input id="create_material_type" name="type" type="hidden" value="PostMaterial">
        @if (!empty($course))
            <input name="course_id" type="hidden" value="{{$course->instance->id}}">
        @endif
        @if (!empty($topic))
            <input name="topic_id" type="hidden" value="{{$topic->instance->id}}">
        @endif
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="bottom-justified-tab2">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <textarea name="description[file]" class="textarea form-control" rows="1" style="resize:vertical;"></textarea>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane" id="bottom-justified-tab3">
                        <div class="form-group">
                            ...
                            <div class="col-md-10">
                                <input name="content[video_url]" class="form-control" type="url">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="control-label col-md-2">Keterangan Tambahan</label>
                            <div class="col-md-10">
                                <textarea name="description[video]" class="textarea form-control" rows="1" style="resize:vertical;"></textarea>
                            </div>
                        </div>
                    </div>
